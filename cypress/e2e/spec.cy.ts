const cities = [
  ...
  {
    "city_id": 73,
    "city_name": "Hoppers Crossing VIC",
    "country_name": "Australia",
    "lat": -37.8629027,
    "lng": 144.6854533,
    "state_code": "VIC"
  ...
  },
  {
    ...
    "country_name": "Canada",
    "lat": 43.3700007,
    "lng": -80.98222860000001,
    "state_code": "ON"
  },
  {
    "city_id": 353,
    "city_name": "Greater Sudbury",
    "country_name": "Canada",
    "lat": 46.4917317,
  ...
  {
    "city_id": 449,
    "city_name": "Puerto Viejo de Talamanca",
    "country_name": "Costa Rica",
    "lat": 9.6540146,
  ...
  {
    "city_id": 511,
    "city_name": "Uherské Hradiště",
    "country_name": "Czech Republic",
    "lat": 49.05979689999999,
    "lng": 17.4958501,
    "state_code": null
  },
  {
    "city_id": 512,
    "city_name": "Ústí nad Labem",
    "country_name": "Czech Republic",
    "lat": 50.6611164,
    "lng": 14.0531455,
    "state_code": null
...
const cityDhaka = {
  ...
  prices: [
    ...
    {
      good_id: 56,
      item_name: 'Domestic Non-Alcoholic Beer, 0.5 liter Draught',
      category_id: 4,
      category_name: 'Markets',
      min: 201.42,
      avg: 352.49,
    ...
    {
      good_id: 59,
      item_name: 'Bottle of Non-Alcoholic Wine, Mid-Range Price',
      category_id: 4,
      category_name: 'Markets',
      min: 352.49,
      avg: 804.83,
    ...
    {
      good_id: 60,
      item_name: 'Domestic Non-Alcoholic Beer, 0.5 liter Bottle',
      category_id: 4,
      category_name: 'Markets',
      min: 100.71,
      avg: 214.22,
    ...
    {
      good_id: 66,
      item_name: 'Imported Non-Alcoholic Beer, 0.33 liter Bottle',
      category_id: 6,
      category_name: 'Restaurants',
      min: 201.42,
      avg: 503.55,
...
describe('GoPlaces', () => {
  ...
  it("get data and choose the country and city", () => {
    ...
    cy.get('.city_page__title').contains('Fier, Albania')
  })
  ...
  it("compare places", () => {
    ...
    cy.get('.comparison').contains('Price per m2 to Buy Apartment Outside of City Center')
  })
  ...
  it("change the language to PL", () => {
    ...
    cy.get('.navbarSettings__lang_cntr').contains('PL')
  })
  ...
  it("change the currency to EUR", () => {
    ...
    cy.get('.navbarSettings__currency_cntr').contains('EUR')
  })
